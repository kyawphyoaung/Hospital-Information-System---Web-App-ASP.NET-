<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReorderLevel.aspx.cs" Inherits="ReorderLevel" %>
    ...
    <div>
        <table colspan="2">
            <tr style="height:30px">
                <td>
                    <h3 style="line-height:15px">Reorder Level Report</h3>
                </td>
            </tr>
            <tr>
                <td>
